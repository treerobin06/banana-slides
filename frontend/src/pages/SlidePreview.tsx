                  ...
                  {isEditingOutline ? (
                    <>
                      <button
                        ...
                        className="px-2 py-1 text-xs bg-banana-500 text-black rounded hover:bg-banana-600 transition-colors"
                      >
                  ...
                  {isEditingDescription ? (
                    <>
                      ...
                      <button
                        ...
                        className="px-2 py-1 text-xs text-gray-700 hover:bg-blue-200 rounded transition-colors"
                      >
                        <X size={14} className="inline mr-1" />
                        取消
                      </button>
                ...
                <div className="px-4 pb-4">
                  {isEditingDescription ? (
                    <textarea
                      ...
                      rows={12}
                      className="w-full px-3 py-2 border border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-banana-500 resize-none text-sm font-mono"
                      placeholder="页面描述（支持Markdown格式）"
                    />
                  ) : (
